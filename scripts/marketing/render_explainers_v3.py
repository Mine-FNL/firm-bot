"""Render the three explainer videos with Samantha voice + prosody.

Replaces the v2 Alex-voice narration with:
  - Samantha (US English female, much warmer than Alex)
  - Slower rate (175 wpm) for deliberate pacing
  - Strategic [[slnc N]] pauses between sentences for natural cadence
  - Rewritten scripts that flow better in spoken form

Same visual quality as v2: 1920x1080, 30fps, H.264 preset slow, crf 18.
"""
...
def mux_audio(video_path: Path, audio_text: str, out_path: Path, voice: str = VOICE, rate: int = RATE) -> None:
    ...
    try:
        r = subprocess.run(
            ["say", "-v", voice, "-r", str(rate), "-o", str(audio_aiff), audio_text],
...
# ============================================================================
# Scripts — written for SPOKEN delivery with Samantha + prosody pauses.
# [[slnc N]] = N milliseconds of silence.
# Smaller pauses (200-300ms) for in-sentence breathing.
# Larger pauses (500-800ms) for paragraph/section breaks.
# ============================================================================

WHY_SCRIPT = """Friday night. [[slnc 600]] Eleven forty-seven PM. [[slnc 500]] Your client just sent a contract question. [[slnc 600]] You need an answer fast.

[[slnc 700]] But the only tool you trust is cloud-based. [[slnc 500]] Every question leaves your network. [[slnc 400]] Vendor large language model. [[slnc 300]] Then subprocessors. [[slnc 300]] Then audit logs. [[slnc 600]] By the time you ask one question, [[slnc 300]] four third parties have seen privileged work product. [[slnc 600]] Compliance review fails. [[slnc 400]] You can't deploy it.

[[slnc 700]] The market for legal AI is ninety percent cloud. [[slnc 500]] The remaining ten percent is what we built. [[slnc 800]] Firm-bot. [[slnc 400]] Local first. [[slnc 400]] Citations required. [[slnc 600]] Your data, [[slnc 400]] your box."""


WHAT_SCRIPT = """What is firm-bot? [[slnc 600]] A local-first chat-bot builder for professional services. [[slnc 500]] Six stages. [[slnc 300]] Zero cloud calls.

[[slnc 600]] Stage one, [[slnc 300]] ingest. [[slnc 400]] PDFs, [[slnc 200]] email, [[slnc 200]] DOCX. [[slnc 500]] Stage two, [[slnc 300]] chunk. [[slnc 400]] Structure aware. [[slnc 400]] Recognises article, [[slnc 200]] section, [[slnc 200]] title case.

[[slnc 500]] Stage three, [[slnc 300]] embed. [[slnc 400]] Local sentence transformers. [[slnc 500]] Stage four, [[slnc 300]] retrieve. [[slnc 400]] BM-25 plus dense, [[slnc 400]] fused with reciprocal rank fusion.

[[slnc 500]] Stage five, [[slnc 300]] answer. [[slnc 400]] Citation required. [[slnc 400]] Every claim must carry a file and page marker. [[slnc 500]] Stage six, [[slnc 300]] guard. [[slnc 400]] A second model audits the answer, [[slnc 400]] and flags ungrounded claims.

[[slnc 700]] The chat card. [[slnc 500]] Every claim carries a source. [[slnc 600]] That's it."""


MAGIC_SCRIPT = """The magic sauce. [[slnc 500]] Three things cloud RAG can't do.

[[slnc 600]] Number one, [[slnc 300]] structure aware chunking. [[slnc 500]] A naive chunker splits mid-clause. [[slnc 500]] We keep Section 4.2 Limitation of Liability intact. [[slnc 500]] Result, [[slnc 300]] point five three eight precision at K, [[slnc 400]] versus point four six two for naive.

[[slnc 700]] Number two, [[slnc 300]] citation required prompts. [[slnc 500]] Without it, [[slnc 400]] "Yes, [[slnc 300]] liability is uncapped." [[slnc 500]] Which page? [[slnc 300]] Which contract? [[slnc 500]] With it, [[slnc 400]] "Liability is uncapped. [[slnc 400]] msa dot pdf, [[slnc 300]] page four." [[slnc 500]] Every claim auditable.

[[slnc 700]] Number three, [[slnc 300]] LLM as judge. [[slnc 500]] A second seven billion parameter model audits every answer. [[slnc 400]] Cites that hold up. [[slnc 400]] Flags that don't.

[[slnc 700]] Twelve-nine tests passing. [[slnc 400]] Zero point five three eight versus zero point four six two. [[slnc 600]] MIT licensed."""


# ============================================================================
# Video 1: why-firm-bot (longer because of narration pauses)
# ============================================================================
...
def video_why() -> Iterator[Image.Image]:
    ...
    for f in range(450):
        ...
        minute_angle = -90 + ease_in_out_cubic(t) * 30
...
def main() -> None:
    import sys
    tmp = Path(tempfile.mkdtemp(prefix="firm-bot-explainers-v3-"))
    jobs = [
    ...
    for name, builder, script in jobs:
        ...
        final = OUT / name
        print(f"  muxing Samantha + prosody audio for {name}…", flush=True)
